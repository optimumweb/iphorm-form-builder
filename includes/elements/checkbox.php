            ...
            <?php
                ...
                <div class="iphorm-input-li iphorm-input-checkbox-li <?php echo $name; ?>-input-li" <?php echo $element->getCss('optionLi'); ?>>
                    <label for="<?php echo $uniqueId . "_$i"; ?>" <?php echo $element->getCss('optionLabel'); ?>>
                        <input class="iphorm-element-checkbox <?php echo $name; ?>" type="checkbox" name="<?php echo $name; ?>[]" id="<?php echo $uniqueId . "_$i"; ?>" value="<?php echo _wp_specialchars($option['value'], ENT_COMPAT, false, true); ?>" <?php echo (in_array($option['value'], $value)) ? 'checked="checked"' : ''; ?> />
