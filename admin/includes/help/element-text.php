...
<h2>Single Line Text Element</h2>
<p>The single line text element can be used to accept small amounts of text and numbers.</p>
...
<?php include IPHORM_ADMIN_INCLUDES_DIR . '/help/settings/filters.php'; ?>
<?php include IPHORM_ADMIN_INCLUDES_DIR . '/help/settings/validators.php'; ?>
</div>