<?php if (!defined('IPHORM_VERSION')) exit; ?><div id="ifb-validator-wrap-<?php echo $validator['element_id']; ?>-<?php echo $validator['id']; ?>" class="ifb-validator ifb-validator-alpha">
    ...
    <?php if (!isset($validator['name'])) $validator['name'] = _x('Alpha', 'the name of the alpha validator which validates that the value contains only alphabet characters', 'iphorm'); ?>
    ...
    <div class="ifb-validator-settings">
        ...
        <table class="ifb-form-table ifb-validator-settings-form-table">
            <?php
                $alphaValidator = new iPhorm_Validator_Alpha();
