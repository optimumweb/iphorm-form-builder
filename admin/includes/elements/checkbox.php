...
$helpUrl = iphorm_help_link('element-checkbox');
?>
<div id="ifb-element-wrap-<?php echo $id; ?>" class="ifb-element-wrap ifb-element-wrap-checkbox <?php if (!$element['required']) echo 'ifb-element-optional'; ?> <?php echo "ifb-label-placement-{$form['label_placement']}"; ?>">
	<div class="ifb-top-element-wrap clearfix">
        <?php include IPHORM_ADMIN_INCLUDES_DIR . '/elements/_actions.php'; ?>
        <div class="ifb-element-preview ifb-element-preview-checkbox">
            ...
            <div class="ifb-preview-input">
                <ul id="ifb_element_<?php echo $id; ?>" class="ifb-checkbox-option-list <?php echo ($element['options_layout'] == 'block') ? 'ifb-options-block' : 'ifb-options-inline'; ?> clearfix">
                    <?php if ($count) : ?>
                        <?php $i = 0; foreach ($element['options'] as $option) : ?>
                            <li><input type="checkbox" name="ifb_element_<?php echo $id; ?>" disabled="disabled" value="<?php echo esc_attr($option['value']); ?>" <?php echo in_array($option['value'], $element['default_value'], true) ? 'checked="checked"' : ''; ?> /><label><?php echo $option['label']; ?></label></li>
                            <?php if ($i == 4) break; ?>
                        <?php $i++; endforeach; ?>
                    <?php endif; ?>
                </ul>
    ...
    <div class="ifb-element-settings ifb-element-settings-checkbox">
            ...
            <div class="ifb-tabs-panel" id="ifb-element-settings-tab-settings-<?php echo $id; ?>">
                <div class="ifb-element-settings-inner">
                    <table class="ifb-form-table ifb-element-settings-form-table ifb-element-settings-settings-form-table">
                        ...
                        <?php include 'settings/options-multiple.php'; ?>
